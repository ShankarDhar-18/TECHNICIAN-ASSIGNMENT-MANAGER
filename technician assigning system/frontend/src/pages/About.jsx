...
const About = () => {
  ...
  const additionalMember = {
    name: 'Vivek Shaw',
    title: 'Senior Accountant & Board Member',
    image: accountantImg,
    description:
  ...
  return (
    ...
    >
      <div className="container">
        <h1 className="text-center mb-5 display-5 fw-bold text-primary">Meet Our Leadership</h1>
            ...
            <div className="col-md-4 mb-4" key={index}>
              ...
              >
                ...
                <div className="card-body text-center">
                  ...
                  <p className="card-text mt-2 text-muted">{member.description}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="row justify-content-center mt-4">
          <div className="col-md-4">
            ...
            >
              ...
              />
              <div className="card-body text-center">
                <h4 className="card-title text-dark">{additionalMember.name}</h4>
                <h6 className="text-secondary">{additionalMember.title}</h6>
                <p className="card-text mt-2 text-muted">{additionalMember.description}</p>
              </div>
            </div>
          </div>
        </div>
